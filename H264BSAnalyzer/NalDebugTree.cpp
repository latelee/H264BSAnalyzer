...
void CNalParser::h264_debug_sps_t(sps_t* sps, HTREEITEM root)
{
    ...
    my_printf("profile_idc : %d\r\n", sps->profile_idc ); AddTreeItem(isps);
    my_printf("constraint_set0_flag : %d\r\n", sps->constraint_set0_flag ); AddTreeItem(isps);
    my_printf("constraint_set1_flag : %d\r\n", sps->constraint_set1_flag ); AddTreeItem(isps);
    my_printf("constraint_set2_flag : %d\r\n", sps->constraint_set2_flag ); AddTreeItem(isps);
    my_printf("constraint_set3_flag : %d\r\n", sps->constraint_set3_flag ); AddTreeItem(isps);
    my_printf("constraint_set4_flag : %d\r\n", sps->constraint_set4_flag ); AddTreeItem(isps);
    my_printf("constraint_set5_flag : %d\r\n", sps->constraint_set5_flag ); AddTreeItem(isps);
    my_printf("reserved_zero_2bits : %d\r\n", sps->reserved_zero_2bits ); AddTreeItem(isps);
    my_printf("level_idc : %d\r\n", sps->level_idc ); AddTreeItem(isps);
    my_printf("seq_parameter_set_id : %d\r\n", sps->seq_parameter_set_id ); AddTreeItem(isps);
    my_printf("chroma_format_idc : %d\r\n", sps->chroma_format_idc ); AddTreeItem(isps);
    if (sps->chroma_format_idc == 3)
        my_printf("separate_colour_plane_flag : %d\r\n", sps->separate_colour_plane_flag ); AddTreeItem(isps);
    my_printf("bit_depth_luma_minus8 : %d\r\n", sps->bit_depth_luma_minus8 ); AddTreeItem(isps);
    my_printf("bit_depth_chroma_minus8 : %d\r\n", sps->bit_depth_chroma_minus8 ); AddTreeItem(isps);
    my_printf("qpprime_y_zero_transform_bypass_flag : %d\r\n", sps->qpprime_y_zero_transform_bypass_flag ); AddTreeItem(isps);
    my_printf("seq_scaling_matrix_present_flag : %d\r\n", sps->seq_scaling_matrix_present_flag ); AddTreeItem(isps);
...
void CNalParser::h265_debug_ptl_t(profile_tier_level_t* ptl, int profilePresentFlag, int max_sub_layers_minus1, HTREEITEM root)
{
    ...
    {
        my_printf("general_profile_space: %d\r\n", ptl->general_profile_space); AddTreeItem(root);
        my_printf("general_tier_flag: %d\r\n", ptl->general_tier_flag); AddTreeItem(root);
        my_printf("general_profile_idc: %d\r\n", ptl->general_profile_idc); AddTreeItem(root);
        for (int i = 0; i < 32; i++)
        {
            my_printf("general_profile_compatibility_flag[%d]: %d\r\n", i, ptl->general_profile_compatibility_flag[i]); AddTreeItem(root);
        }
        my_printf("general_progressive_source_flag: %d\r\n", ptl->general_progressive_source_flag); AddTreeItem(root);
        my_printf("general_interlaced_source_flag: %d\r\n", ptl->general_interlaced_source_flag); AddTreeItem(root);
        my_printf("general_non_packed_constraint_flag: %d\r\n", ptl->general_non_packed_constraint_flag); AddTreeItem(root);
        my_printf("general_frame_only_constraint_flag: %d\r\n", ptl->general_frame_only_constraint_flag); AddTreeItem(root);
        ...
        {
            my_printf("general_max_12bit_constraint_flag: %d\r\n", ptl->general_max_12bit_constraint_flag); AddTreeItem(root);
            my_printf("general_max_10bit_constraint_flag: %d\r\n", ptl->general_max_10bit_constraint_flag); AddTreeItem(root);
            my_printf("general_max_8bit_constraint_flag: %d\r\n", ptl->general_max_8bit_constraint_flag); AddTreeItem(root);
            my_printf("general_max_422chroma_constraint_flag: %d\r\n", ptl->general_max_422chroma_constraint_flag); AddTreeItem(root);
            my_printf("general_max_420chroma_constraint_flag: %d\r\n", ptl->general_max_420chroma_constraint_flag); AddTreeItem(root);
            my_printf("general_max_monochrome_constraint_flag: %d\r\n", ptl->general_max_monochrome_constraint_flag); AddTreeItem(root);
            my_printf("general_intra_constraint_flag: %d\r\n", ptl->general_intra_constraint_flag); AddTreeItem(root);
            my_printf("general_one_picture_only_constraint_flag: %d\r\n", ptl->general_one_picture_only_constraint_flag); AddTreeItem(root);
            my_printf("general_lower_bit_rate_constraint_flag: %d\r\n", ptl->general_lower_bit_rate_constraint_flag); AddTreeItem(root);
            my_printf("general_reserved_zero_34bits: %u\r\n", ptl->general_reserved_zero_34bits); AddTreeItem(root); // tocheck
        }
        else
        {
            my_printf("general_reserved_zero_43bits: %u\r\n", ptl->general_reserved_zero_43bits); AddTreeItem(root);// tocheck
        }
        ...
        {
            my_printf("general_inbld_flag: %d\r\n", ptl->general_inbld_flag); AddTreeItem(root);
        }
        else
        {
            my_printf("general_reserved_zero_bit: %d\r\n", ptl->general_reserved_zero_bit); AddTreeItem(root);
        }
    }
        
    my_printf("general_level_idc: %d\r\n", ptl->general_level_idc); AddTreeItem(root);
    for (int i = 0; i < max_sub_layers_minus1; i++)
    {
        my_printf("sub_layer_profile_present_flag[%d]: %d\r\n", i, ptl->sub_layer_profile_present_flag[i]); AddTreeItem(root);
        my_printf("sub_layer_level_present_flag[%d]: %d\r\n", i, ptl->sub_layer_level_present_flag[i]); AddTreeItem(root);
    }
    if (max_sub_layers_minus1 > 0)
    {
        for (int i = max_sub_layers_minus1; i < 8; i++)
        {
            my_printf("reserved_zero_2bits[%d]: %d\r\n", i, ptl->reserved_zero_2bits[i]); AddTreeItem(root);
        }
    }
    for (int i = 0; i < max_sub_layers_minus1; i++)
    {
        ...
        {
            my_printf("sub_layer_profile_space[%d]: %d\r\n", i, ptl->sub_layer_profile_space[i]); AddTreeItem(root);
            my_printf("sub_layer_tier_flag[%d]: %d\r\n", i, ptl->sub_layer_tier_flag[i]); AddTreeItem(root);
            my_printf("sub_layer_profile_idc[%d]: %d\r\n", i, ptl->sub_layer_profile_idc[i]); AddTreeItem(root);
            for (int j = 0; j < 32; j++)
            {
...
void CNalParser::h265_debug_vps_t(h265_vps_t* vps, HTREEITEM root)
{
    ...
    my_printf("vps_video_parameter_set_id: %d\r\n", vps->vps_video_parameter_set_id); AddTreeItem(ivps);
    my_printf("vps_base_layer_internal_flag: %d\r\n", vps->vps_base_layer_internal_flag); AddTreeItem(ivps);
    my_printf("vps_base_layer_available_flag: %d\r\n", vps->vps_base_layer_available_flag); AddTreeItem(ivps);
    my_printf("vps_max_layers_minus1: %d\r\n", vps->vps_max_layers_minus1); AddTreeItem(ivps);
    my_printf("vps_max_sub_layers_minus1: %d\r\n", vps->vps_max_sub_layers_minus1); AddTreeItem(ivps);
    my_printf("vps_temporal_id_nesting_flag: %d\r\n", vps->vps_temporal_id_nesting_flag); AddTreeItem(ivps);
    my_printf("vps_reserved_0xffff_16bits: %d\r\n", vps->vps_reserved_0xffff_16bits); AddTreeItem(ivps);
    // ptl
    ...
    if (vps->vps_sub_layer_ordering_info_present_flag)
    {
        ...
        {
            my_printf("vps_max_dec_pic_buffering_minus1[%d]: %d\r\n", i, vps->vps_max_dec_pic_buffering_minus1[i]); AddTreeItem(isub);
            my_printf("vps_max_num_reorder_pics[%d]: %d\r\n", i, vps->vps_max_num_reorder_pics[i]); AddTreeItem(isub);
            my_printf("vps_max_latency_increase_plus1[%d]: %d\r\n", i, vps->vps_max_latency_increase_plus1[i]); AddTreeItem(isub);
        }
    }

    my_printf("vps_max_layer_id: %d\r\n", vps->vps_max_layer_id); AddTreeItem(ivps);
    my_printf("vps_num_layer_sets_minus1: %d\r\n", vps->vps_num_layer_sets_minus1); AddTreeItem(ivps);
    ...
    my_printf("vps_extension_flag: %d\r\n", vps->vps_extension_flag); AddTreeItem(ivps);
...
void CNalParser::h265_debug_nal_t(h265_stream_t* h, h265_nal_t* nal)
{
    ...
    my_printf("NAL\r\n");
    HTREEITEM root = AddTreeItem(TVI_ROOT);
    my_printf("forbidden_zero_bit : %d\r\n", nal->forbidden_zero_bit); AddTreeItem(root);
    my_printf("nal_unit_type : %d ( %s )\r\n", nal->nal_unit_type, nal_unit_type_name); AddTreeItem(root);
    my_printf("nal_ref_idc : %d\r\n", nal->nuh_layer_id); AddTreeItem(root);
    my_printf("nal_ref_idc : %d\r\n", nal->nuh_temporal_id_plus1); AddTreeItem(root);
